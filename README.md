...
### ✔️ ??? 프로젝트 (메티버스 아카데미 2기 AI반 Deep Learning 프로젝트)

# 📃 프로젝트 소개

### ✔️ 딥러닝(CNN 등)을 활용한 ??? 프로젝트입니다.  
...
### ✔️ 팀원
메타버스 아카데미 2기 AI반 김명진, 여형구, 임정민, 김해니 총 4명(나이순)

메타버스 아카데미 2기 AI반 김명진, 김해니, 여형구, 임정민 총 4명(이름순)
...
### ✔️ 세부 진행 기록
- 23-07-14 : 회의 및 주제 정하기, 보배드림 데이터 크롤링
- 23-07-15 : Dacon 데이터 수집, EDA
- 23-07-16 : PPT 초안 작성, EDA, 워드클라우드
- 23-07-17 : 머신 러닝 회귀 모델링 (XGBoost/LightGBM, RandomForest, LinearRegression, Lasso)
- 23-07-18 : K-Fold 학습, GridSearchcv 하이퍼파라미터 튜닝 학습 후 비교
- 23-07-19 : GridSearchcv 하이퍼파라미터 튜닝, AutoML (Pycaret) 학습, PPT 수정
- 23-07-20 : 
- 23-07-21 : AutoML(Optuna, Autogluon)학습, 각 모델별 MAE 비교, 인사이트 도출 , PPT 수정, 발표 대본 작성
- 23-07-31 : PT 발표 및 질의응답
