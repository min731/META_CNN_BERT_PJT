...
온라인 광고 시장에서는 검색 기록이나 자주 보는 컨텐츠를 기반으로 맞춤형 광고를 제공하는 예시를 쉽게 찾아볼 수 있습니다. 이와 유사한 접근법으로 옥외광고에 적용할 수 있다면, 광고주는 자신들의 광고가 실제로 송출될 때만 비용을 지불하는 효율적인 시스템을 이용할 수 있을 것입니다. 또한 이러한 방식은 소비자에게도 이점을 가져다주는데, 기존의 무분별한 광고 대신 연령과 성별을 기반으로 한 맞춤형 광고를 통해 관심 있는 제품이나 서비스에 집중할 수 있게 해주니다. 이로 인해 소비자는 불필요한 정보 없이 효율적인 쇼핑 이용이 가능해질 것으로 예상되어 이번 주제를 선정하게 되었습니다.
